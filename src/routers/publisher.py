...
def get_publisher(publisher_id: int, publisher_service: publisher_dependency) -> PublisherDTO | None:
...
def add_publisher(publisher: PublisherAddDTO, publisher_service: publisher_dependency) -> PublisherDTO:
    publisher = publisher_service.create(publisher)
    return publisher


@router.delete("/{publisher_id}", summary="Удалить издателя по id")
def delete_publisher(publisher_id: int, publisher_service: publisher_dependency):
...
def update_publisher(
    publisher_id: int, publisher: PublisherAddDTO, publisher_service: publisher_dependency
) -> PublisherDTO | None:
